  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 px-6 text-center">
      ...
      <motion.h2
        ...
        className="text-xl font-semibold text-foreground mb-1.5 text-center"
      >
      ...
      <div className="h-5 mb-8 flex items-center justify-center w-full">
      ...
      >
        ...
        >
          ...
          <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest text-center">Energy</span>
        </motion.div>
        ...
        >
          ...
          <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest text-center">Water</span>
        </motion.div>
        ...
        >
          ...
          <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-widest text-center">Eco</span>
        </motion.div>
      </motion.div>
